    ...
    <div class="container">
        <div class="tab-list-flex">
           <div class="tabbox-css create-new-course-curricullumform">
            <h3>Create New Course Curriculum</h3>
               <div class="form-changepassword">
                  <form method="post" action="{{Route('course.curriculm')}}"  enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-login mb-0">
                        <div class="row">
                           <div class="col-lg-12">
                              ...
                              <select name="category_id" class="my-from-control selectcol choosecategory" aria-label="Select Category" required>
                     ...
                     <div class="form-login mb-0">
                        <div class="row">
                           <div class="col-lg-12">
                              ...
                              <select name="course_id" class="my-from-control selectcol choosecourse" aria-label="Select Course" required>
                     ...
                     <div class="form-login mb-0">
                        <div class="row">
                           <div class="col-lg-12">
                              ...
                              <select name="header_id" class="my-from-control selectcol" aria-label="Select Header " required>
                     ...
                     <div class="form-login mb-0">
                        <div class="row">
                           <div class="col-lg-12">
                              ...
                              <select name="footer_id" class="my-from-control selectcol" aria-label="Select Footer" required>
           ...
           <div class="pdfviewerbox">
            ...
            <embed src= "https://course.cromacampus.com/public/loadpdf/my.pdf#toolbar=0&navpanes=0&scrollbar=0" width= "100%" height= "500px" frameborder="0">
              <div class="text-center downloadpdf mt-3">
               <a href="https://course.cromacampus.com/public/loadpdf/my.pdf" class="btn btn-third" target="_blank">
