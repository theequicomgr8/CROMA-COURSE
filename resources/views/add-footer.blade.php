   ...
   <div class="tab-pane fade show active" id="pills-rankview" role="tabpanel" aria-labelledby="pills-rankview-tab">
    ...
    <div class="container">
        <div class="tab-list-flex">
            <form method="post" action="{{Route('footer.save')}}" enctype="multipart/form-data">
                @csrf
                 ...
                 <div class="add-course padding-20">
                    ...
                    <div class="grid-two">
                        <div class="form-group">
                            <h4>Footer Name</h4>
                            <input type="text" name="name" id="getname" class="my-from-control" placeholder="Enter Footer Name">
                        </div>
                        <div class="form-group">
                            <h4>Upload Footer</h4>
                            <div class="d-flex gap-2">
                              <div class="imageWrapper">
                               ...
                               <button class="file-upload">            
                                 <input type="file" class="file-input" name="footer_pic[]" multiple accept="image/png, image/gif, image/jpeg" />Browse File
                               </button>
                            </div>
                          ...
                          <tbody>
                             ...
                             <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>
                                            <!--{{basepath('footer/'.$value->footer_pic)}}-->
                                            <a href="footerimage/{{$value->id}}" target="_blank"><img src="{{basepath('images/pdficon.svg')}}" alt="editicon"></a>
                                        </li>
                                    </ul>
                                </td>
                                ...
                                <td>
                                    @if($value->status==0)
                                    <span class="bg-yellow badges changestatus" data-id='{{$value->id}}' data-table='footers' data-vaalue='0' style="cursor: pointer;">Deactive</span>
                                    @else
                                    <span class="bg-green badges changestatus" data-id='{{$value->id}}' data-table='footers' data-vaalue='1' style="cursor: pointer;">Active</span>
                                    @endif
                                </td>
                                <td>
                                   <ul>
                                      <li><span  class="footer_edit" data-name="{{$value->name}}" data-id="{{$value->id}}"><img src="{{basepath('images/editicon.svg')}}" alt="editicon"></span></li>
                                      <li><a href="" class="delete" data-id='{{$value->id}}' data-table='footers'><img src="{{basepath('images/deleteicon.svg')}}" alt="deleteicon"></a></li>
                                   </ul>
                                </td>
                             </tr>
                             @endforeach
...
<script>
   $(document).on("click",".footer_edit",function(){
      var id=$(this).attr('data-id');
      var name=$(this).attr('data-name');
      $("#getid").attr("value",id);
      $("#getname").attr("value",name);
